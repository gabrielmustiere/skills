...
> Référence d'intention : `docs/story/NNN-f-slug/plan.md` | `docs/story/NNN-r-slug/plan.md` | `docs/story/NNN-t-slug/plan.md` | "Aucune"
...
**Tags possibles** : `SECU`, `BUG`, `MIGRATION`, `PERF`, `ARCHI`, `CHANNEL`, `THEME`, `PLAN`, `STYLE`, `I18N`, `API`, `CONV` (convention framework).
